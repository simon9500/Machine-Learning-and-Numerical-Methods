...
#features = ['Temperature', 'Visibilty', 'Pressure', 'Pressure Trend', 'Humidity', 'Time since midnight',
#            'Wind Direction', 'Wind Speed', 'Elevation', 'Latitude']
#features = ['Temperature', 'Visibilty', 'Pressure', 'Pressure Trend', 'Humidity',
#             'Gust', 'Wind Direction', 'Time since midnight']
#features = ['Temperature', 'Visibilty', 'Pressure', 'Pressure Trend', 'Humidity',
#             'Gust', 'Wind Direction', 'Time since midnight', 'Wind Speed', 'Dew Point']
features = ['Temperature', 'Visibilty', 'Pressure', 'Pressure Trend', 'Humidity']
